...
/*public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonHaut=(Button)findViewById(R.id.buttonHaut);
        Button buttonBas=(Button)findViewById(R.id.buttonBas);

        //Envoyer du text à notre 2e activité

        buttonHaut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent startIntent=new Intent(getApplicationContext(),Main2Activity.class);
                //passer une info à la seconde activité
                startIntent.putExtra("com.example.a2eappl.qqchose","slt le monde!");
                startActivity(startIntent);
            }
        });

        //Ouvrir une application (google)

        buttonBas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String adresse="http://www.google.com";
                Uri webadresse=Uri.parse(adresse);

                Intent ouvrirPage=new Intent(Intent.ACTION_VIEW,webadresse);
                startActivity(ouvrirPage);
            }
        });
    }
}*/
